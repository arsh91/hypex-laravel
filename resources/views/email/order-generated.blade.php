                            ...
                            <td style="padding-top:0px;padding-bottom:30px;padding-right:37px;padding-left:37px">
                                <table cellspacing="0" cellpadding="0" border="0" >
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="font-family:Arial,Helvetica,sans-serif;font-size:16px;color:#293136;line-height:24px;padding-bottom:24px" valign="top" align="left">ORDER GENERATED SUCCESSFULL !!  </td>
                                        </tr>
                                        <tr>
                                            <td style="font-family:Arial,Helvetica,sans-serif;font-size:16px;color:#293136;line-height:24px;padding-bottom:24px" valign="top" align="left">Your ORDER for the product <strong>{{ $prodName }}</strong> has been recieved successfully !! </td>
                                        </tr>
                                    </tbody>
                                </table> 
