...
<html lang="en">
<head>
<title>Hypex : Sell Offer Generated</title>
<meta charset="utf-8">
                        ...
                        <tr>
                            <td>      
                                <table cellspacing="0" cellpadding="0" border="0">
                                    <tbody>
                                        <tr>
                                            <td><a href="{{ url('/') }}/products/shoes"><img src="{{ url('public/v1/website/img/order_generation.png') }}" alt="" width="600px"></a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
                            ...
                            <td style="padding-top:0px;padding-bottom:30px;padding-right:37px;padding-left:37px">
                                <table cellspacing="0" cellpadding="0" border="0" >
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="font-family:Arial,Helvetica,sans-serif;font-size:16px;color:#293136;line-height:24px;padding-bottom:24px" valign="top" align="left">SELLING OFFER COLLECTED SUCCESSFULL !!  </td>
                                        </tr>
                                        <tr>
                                            <td style="font-family:Arial,Helvetica,sans-serif;font-size:16px;color:#293136;line-height:24px;padding-bottom:24px" valign="top" align="left">Your SELLING Offer for the product <strong>{{ $prodName }}</strong> has been recieved successfully !! </td>
                                        </tr>
                                    </tbody>
                                </table> 
                                    ...
                                    <tr>
                                        <td style="vertical-align: top; width:50%; padding:10px">
                                            <table style="width:100%; padding-bottom:20px;">
                                                <tr><td><p style="font-weight:500; margin:0; padding:10px; border-bottom:1px solid #ccc; font-size:18px;">Bid Offer Summery</p></td></tr>
                                            </table>    

                                            <table style="width:100%; ">                                    
                                                <tr>                                        
                                                    <td><img width="80px" height="auto;" src="{{ url('/') }}/{{$imageLink}}" alt="" style="padding-right:15px;" /></td>
                                                    <td>
                                                        <p style="margin:0; padding:2px 0;"><strong>{{ $prodName }}</strong></p>
                                                        <p style="margin:0; padding:2px 0;">Size : {{ $size }}</p>
                                                        <p style="margin:0; padding:2px 0;">Quentity : 1</p>
                                                        <p style="margin:0; padding:2px 0;">Price : <strong>CA ${{ $sellPrice }}</strong></p>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <td style="vertical-align: top; width:50%; padding:10px;">
                                           <table style="width:100%; padding-bottom:20px;">
                                            ...
                                            <table style="width:100%; padding:10px; background:#f8f8f8;">   
                                                ...
                                                <!--tr><td style="padding:5px 0; color:#888">Product Total :</td><td style="padding:5px 0; color:#888; text-align:right">CA ${{ $sellPrice }}</td></tr>
                                                ...
                                                <tr><td style="padding:5px 0;">Product Total</td><td style="padding:5px 0; width:80px; text-align:right">CA ${{ $sellPrice }}</td></tr>

                                                <tr><td><h2 style="font-size:16px; color:#293136; margin:0; padding-top:10px;">Billing Address</h2></td></tr>
                                                <tr><td><p style="font-size:15px; color:#888; margin:0; padding-top:10px;">

                                                {{ $billingAdd }}, {{ $billingCity }}, {{ $billingCountry }}, {{ $billingZip }}
                                                ...
                                                <tr><td><p style="font-size:15px; color:#888; margin:0; padding-top:10px;">
                                                    ...
                                                    {{ $shippingAdd }}, {{ $shippingCity }}, {{ $shippingCountry }}, {{ $shippingZip }}
