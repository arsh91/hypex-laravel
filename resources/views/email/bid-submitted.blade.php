...
<html lang="en">
<head>
<title>Hypex : Bid Offer Generated</title>
<meta charset="utf-8">
                            ...
                            <td style="padding-top:0px;padding-bottom:30px;padding-right:37px;padding-left:37px">
                                <table cellspacing="0" cellpadding="0" border="0" >
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="font-family:Arial,Helvetica,sans-serif;font-size:16px;color:#293136;line-height:24px;padding-bottom:24px" valign="top" align="left">BID OFFER COLLECTED SUCCESSFULL !!  </td>
                                        </tr>
                                        <tr>
                                            <td style="font-family:Arial,Helvetica,sans-serif;font-size:16px;color:#293136;line-height:24px;padding-bottom:24px" valign="top" align="left">Your Bid Offer for the product <strong>{{ $prodName }}</strong> has been recieved successfully !! </td>
                                        </tr>
                                    </tbody>
                                </table> 
                                            ...
                                            <table style="width:100%; ">                                    
                                                <tr>                                        
                                                    ...
                                                    <td>
                                                        ...
                                                        <p style="margin:0; padding:2px 0;">Price : <strong>CA ${{ $bidPrice }}</strong></p>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <td style="vertical-align: top; width:50%; padding:10px;">
                                           <table style="width:100%; padding-bottom:20px;">
                                            ...
                                            <table style="width:100%; padding:10px; background:#f8f8f8;">   
                                                ...
                                                <!--tr><td style="padding:5px 0; color:#888">Product Total :</td><td style="padding:5px 0; color:#888; text-align:right">CA ${{ $bidPrice }}</td></tr>
                                                ...
                                                <tr><td style="padding:5px 0;">Product Total</td><td style="padding:5px 0; width:80px; text-align:right">CA ${{ $bidPrice }}</td></tr>
