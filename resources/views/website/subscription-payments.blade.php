...
<div class="container">
		<div class='row hypeCardPage'>
			...
			<div class='hype-card-block cardDetailForm'>
                ...
                <form accept-charset="UTF-8" action="{{ route('charge-subcription') }}" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="pk_test_4IM4LmSwVO580Z1zC3BsShzx" id="payment-form" method="POST">
				<!--<form accept-charset="UTF-8" action="{{ route('charge-subcription') }}" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="pk_live_VCgTWfZJ6eQGGJPba9ddqug3" id="payment-form" method="POST">-->
					...
					<div class='form-row'>
						<div class='col-md-12 form-group'>
							<button class='form-control btn btn-primary submit-button'
								type='submit' style="margin-top: 10px;">@lang('home.Pay Now')</button>
						</div>
					</div>
					<div class='form-row'>
                    ...
                    <div class="hidden_fields">
                        <input type="hidden" name="plan_id" value="prod_FM13JSU1zoc0v7">
                        <input type="hidden" name="plan_name" value="Hypex Monthly Plan">
                        <input type="hidden" name="plan_interval" value="day">
