...
@section('content')
    <form id="purchaseBid" name="purchaseBid" method="POST" action="{{ route('purchasePromo') }}">
        @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-6 col-xs-12">
                        ...
                        <p class="productPrice">
                            ...
                            {{Session::get('pass_value')}}
                            <span>@lang('home.Promo Offer')</span>
                            
                        </p>
                        <input type="hidden" id="hiddenPrice" name="hiddenPrice"
                            value="{{Session::get('pass_value')}}">
                        @else
    ...
    <script>
       ...
       // $('#billing_province').prop('disabled',true);
        ...
        function getProvince() {
            ...
            $.ajax({
                type: "POST",
                url: "http://localhost/hypex/hypex-website/getProvince",
                data: 'country_id=' + val,
                dataType: 'json',
