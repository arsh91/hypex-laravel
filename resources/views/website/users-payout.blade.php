...
<div class="container">
<br/>
<form accept-charset="UTF-8" action="{{ route('save-payouts') }}" class="require-validation" data-cc-on-file="false"
					id="payout-form" method="POST">
				<!--form accept-charset="UTF-8" action="{{ route('save-cards') }}" class="require-validation" data-cc-on-file="false"
					...
					<div class='form-row'>
						<div class='col-xs-8 form-group required'>
							<label class='control-label'>@lang('home.Payout Email Address')</label> <input
								class='form-control cardname' id="email"  name="email" minlength="5" maxlength="20" type='email'>
						</div>
					</div>
                    <br/>
                    <div class='form-row'>
						<div class='col-xs-4 form-group'>
							<button class='form-control btn btn-primary submit-button'
								type='submit' style="margin-top: 10px;">@lang('home.Save Payout')</button>
						</div>
					</div>
</form>
</div>
   ...
   <h3>@lang('home.My Saved Payout')</h3>
    <br/>
        <div class="saved-payment-cards">
            ...
            @endif	
             ...
             @if(count($paydetails) == 0)
                 <h4>@lang("home.You don't have any Payout info saved").</h4>
             @endif	
