...
@section('content')
<form id="purchaseBid" name="purchaseBid" method="POST" action="{{ route('purchaseBid') }}">
@csrf
                        ...
                        <div class="row">
                         ...
                         <div class="col-sm-6 col-lg-6 col-xs-12">
							...
							@if(isset($maxBidsData[$productDetails['size']]))
								...
								<input type="hidden" id="hiddenPrice" name="hiddenPrice" value="{{ $maxBidsData[$productDetails['size']] }}">
							@else
          ...
          <div class="panel panel-default">
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
              <div class="panel-body">
					...
					<input required id="shipping_full_address" placeholder="Full Address" name="shipping_full_address" type="text" value="{{old('shipping_full_address')}}" maxlength='15'>
					...
					<input required id="shipping_zip" placeholder="Zip Code" name="shipping_zip" type="text" value="{{old('zip')}}" maxlength='8' minlength='4'>    					
              </div>
            </div>
          </div>
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                 ...
                 <div class="col-lg-4 col-md-4 col-xs-12">
                  ...
                  <div class="shippingLoader" style="display: none;">Loading...</div>
                   ...
                   <li><button type="submit" value="submit" id="purchaseNowButton">Submit</button></li>
                </ul> 
...
$('#purchaseBid').submit(function(e) {
  ...
  var formValues = {};
  $('#purchaseBid input').each(function(element){                   
        if($.trim($(this).val()) == "") {
              error = error + 1;
        }
  }); // loop ends here
  ...
  $.each($('#purchaseBid').serializeArray(), function(i, field) {
        ...
        request.onreadystatechange = function () {
          if (this.readyState === 4) {
            ...
            if(this.status == 200){
              ...
              $('.shippingDiv').show(); //display the price section
