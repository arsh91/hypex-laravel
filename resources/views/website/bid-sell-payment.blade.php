        ...
        <div class='row hypeCardPage'>
            ...
            <div class='hype-card-block'>
                <div class="hypeCard cardPadding">
                    ...
                    <div class="hypeCardFace hypeCardFace-back">
                        ...
                        <div class="cardCvv">
                            <div class="cvvStripe"></div>
                            <span class="backsideCVV">CVC</span></div>
			...
			<div class='hype-card-block cardDetailForm'>
				<script src='https://js.stripe.com/v2/' type='text/javascript'></script>
                 <form accept-charset="UTF-8" action="{{ route('create-customer') }}" class="require-validation" data-cc-on-file="false"
				...
				<!--form accept-charset="UTF-8" action="{{ route('create-customer') }}" class="require-validation" data-cc-on-file="false"
					...
					@if(base64_decode($type) == 'sell')
						<!-- account details -->
							<div class='form-row'>
							<div class='col-xs-12 form-group required'>
								<label class='control-label'>@lang('home.Payout PayPal Email')</label> <input
									class='form-control paypal_id' name="paypal_id" size='4' type='email' pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" size="30" required>
							</div>
						</div>
						<!-- account details -->
					@endif
					...
					<div class='form-row'>
						<div class='col-xs-4 form-group cvc required'>
							<label class='control-label'>@lang('home.CVC')</label> <input
								...
								placeholder="@lang('home.CVC')" maxlength="4" type='text'>
						</div>
					...
					<div class='form-row'>
						<div class='col-md-12 form-group'>
							<button class='form-control btn btn-primary submit-button'
								type='submit' style="margin-top: 10px;">@lang('home.Pay')  ${{ Session::get('commissionPrice') }}</button>
						</div>
					</div>
					<div class='form-row'>
						<div class='col-md-12 error form-group hide'>
							<div class='alert-danger alert'>@lang('home.Please correct the errors and try
								again.')</div>
						</div>
					</div>
						<input type="hidden" value="{{ $type }}" name="type">
						<input type="hidden" value="{{ $primary }}" name="primary">
				</form>
    ...
    <script>
        $(function () {
            $('form.require-validation').bind('submit', function (e) {
				...
				var inputSelector = ['input[type=password]', 'input[type=text]', 'input[type=file]', 'textarea'].join(', ');
