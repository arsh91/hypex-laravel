  ...
  <div class="index-block product-block">    
            ...
            @endphp
              ...
              @endif
                 ...
                 <li>CA $<input type="number" min="1"  step="1" name="bid_price" required placeholder='Enter Amount'><p>Enter An Offer</p></li>
   ...
   <div class="index-block productInfo">
        ...
        <span id="shippingError" style="color:red;"></span>
          ...
          <div class="panel panel-default">
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
              <div class="panel-body">
					...
					<input required id="shipping_street_city" placeholder="City" name="shipping_street_city" type="text" value="{{old('shipping_street_city')}}" onblur="copy(this);" maxlength='15'>
              ...
              <option value="YT">Yukon</option>
					...
					<input required id="shipping_zip" placeholder="Zip Code" name="shipping_zip" type="text" value="{{old('zip')}}" onblur="copy(this);" maxlength='8' minlength='4'>    					
              </div>
            </div>
          </div>
          <div class="panel panel-default">
          ...
          <input required id="billing_zip" placeholder="Zip Code" name="billing_zip" type="text" value="{{old('zip')}}" maxlength='8' minlength='4'> 
              </div>
            </div>
          </div>
		  <label>
          ...
          <input required type="text" value=""> 
                 ...
                 <div class="col-lg-4 col-md-4 col-xs-12">
                  ...
                  <div class="shippingLoader" style="display: none;">Loading...</div>
                   ...
                   <li><button type="submit" id="bidNowButton">Submit</button></li>
                </ul> 
...
$('#sellData').submit(function(e) { 
  ...
  e.preventDefault();    
  var formValues = {};
  $('#sellData input').each(function(element){                   
        if($.trim($(this).val()) == "") {
              error = error + 1;
        }
  ...
  $.each($('#sellData').serializeArray(), function(i, field) {
  ...
  if(!error) {
     $('.shippingLoader').show(); //show the loader before request
        ...
        request.onreadystatechange = function () {
          if (this.readyState === 4) {
            ...
            if(this.status == 200){
              ...
              var shoePrice = formValues.bid_price; //get the sell price in offer
        ...
        var body = {
            ...
            "toPostalCode": "V6V 1Z4", //client's headquaters
