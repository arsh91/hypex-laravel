                ...
                <div id="exTab1" class="container-fluid">
                    ...
                    <div class="col-md-12">
                        <ul class="navtabsAccount accountTabsColor">
                            <li class="active"><a href="#1a" data-toggle="tab">@lang('home.View Return Addresses')</a></li>
                        </ul>
                    </div><!-- col ends -->
                          ...
                          @if($count >0)
                                ...
                                <div class="row-fluid accountEditBreak">
                                    <div class="accountEditRow">
                                        ...
                                        <div class="inputEdit">
                                            <a href="{{url('update-return-address'.'/'.$shipAddr['id'])}}">@lang('home.Edit')</a>
                                            <a href="{{url('delete-return-address'.'/'.$shipAddr['id'])}}"> / @lang('home.Delete')</a>
                                        </div>
