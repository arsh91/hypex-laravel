...
<div class="container fullHeight-container">
		<div class='row hypeCardPage'>
                ...
                <div class="hypeCard cardPadding">
                    ...
                    <!-- ============================================= card face 2 start ===================== -->
                     ...
                     <div class="hypeCardFace hypeCardFace-back">
                        ...
                        <div class="cardCvv"><div class="cvvStripe"></div><span class="backsideCVV">CVC</span></div>
			...
			<div class='hype-card-block cardDetailForm'>
                ...
                <form accept-charset="UTF-8" action="{{ route('deduct-payment') }}" class="require-validation" data-cc-on-file="false"
