		...
		<div class='row hypeCardPage'>
			...
			<div class='hype-card-block cardDetailForm'>
				<script src='https://js.stripe.com/v2/' type='text/javascript'></script>
                  ...
                  <form accept-charset="UTF-8" action="{{ route('vip-payment') }}" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="pk_test_4IM4LmSwVO580Z1zC3BsShzx" id="payment-form" method="POST"> 

				 <!--form accept-charset="UTF-8" action="{{ route('vip-payment') }}" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="pk_live_VCgTWfZJ6eQGGJPba9ddqug3" id="payment-form" method="POST"-->
					...
					<div class='form-row'>
						<div class='col-md-12 form-group'>
							<button class='form-control btn btn-primary submit-button'
								type='submit' style="margin-top: 10px;">Pay ${{ Session::get('totalPrice') }}</button>
						</div>
					</div>
					<div class='form-row'>
