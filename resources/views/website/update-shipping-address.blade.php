                ...
                <div id="exTab1" class="container-fluid">
                    ...
                    <div class="col-md-12">
                        <ul class="navtabsAccount">
                            <li class="active"><a href="#1a" data-toggle="tab">@lang('home.Update Shipping Address')</a></li>
                        </ul>
                    </div><!-- col ends -->
                    <form method="POST" action="{{ url('update-shipping-address'.'/'.$shipAddr_id) }}">
                        @csrf
                                ...
                                <div class="tab-pane-inner">
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="col-md-6 colinput">
                                            <input id="first_name" value="{{ old('first_name', $userShipAddr['first_name']) }}" name="first_name" type="text" required>
                                            <label for="first_name">@lang('home.First Name')</label>
                                        </div> <!-- col ends -->

                                        <div class="col-md-6 colinput">
                                            <input id="last_name" value="{{ old('last_name', $userShipAddr['last_name']) }}" name="last_name" type="text" required>
                                    ...
                                    <div class="row-fluid">
                                        <div class="colinput">
                                            <input id="full_address" value="{{ old('full_address', $userShipAddr['full_address']) }}" name="full_address" type="text" required>
                                            <label for="full_address">@lang('home.Full Address')</label>
                                        </div> <!-- col ends -->

                                        <div class="colinput">
                                            <input id="street_city" value="{{ old('street_city', $userShipAddr['street_city']) }}" name="street_city" type="text" required>
                                    ...
                                    <div class="row-fluid">
                                        <div class="colinput">
                                            <input id="phone_number" value="{{ old('phone_number', $userShipAddr['phone_number']) }}" name="phone_number" type="text" required>
                                            <label for="phone_number">@lang('home.Phone Number')</label>
                                        </div> <!-- col ends -->

                                        <div class="colinput">
                                            <input id="zip_code" value="{{ old('zip_code', $userShipAddr['zip_code']) }}" name="zip_code" type="text" required>
                                    ...
                                    <div class="row-fluid">
                                        <div class="colinput" id="shipCheckbox">
                                            <input type="checkbox" name="default" value="1" <?php echo ($userShipAddr['default']==1 ? 'checked' : '');?>><span id="shipCheckboxSpan">@lang('home.Set As Default Address')</span>
                                        </div>
                                    </div>
