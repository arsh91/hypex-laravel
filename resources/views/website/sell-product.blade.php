                    ...
                    <div class="col-lg-6 col-xs-12">
                        ...
                        @if(isset($minSellData[$productDetails['size']]))
                            ...
                            <p class="productPrice">
                                ...
                                {{--    {{App\Http\Controllers\v1\website\UsersController::changePrice(Session::get('currencyCode'), $currency_code, $minSellData[$productDetails['size']])}}--}}
                            ...
                            <input type="hidden" name="hiddenPrice" value="{{ $minSellData[$productDetails['size']] }}">
                        @else
                        ...
                        <ul class="parallelFields">
                            ...
                            <li>@if(Session::get('currencyCode') != '')
                                    {{Session::get('currencyCode')}}
                                    @else
                                    
                                    @endif
                             <input type="number" id="enterBidPrice" min="1" step="1" name="bid_price" required
                                           placeholder="@lang('home.Enter Amount')">
                                <p>@lang('home.Enter An Offer')</p></li>
                            <li><select name="bid_days" required placeholder="Select Date">
                                ...
                                <p>@lang('home.Expiration Date')</p></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-xs-12">
                        ...
                        <ul class="borderLeft">
                            ...
                            <li id="shiipingCostSection">
                                <div class="shippingLoader" style="display: none;color: green;font-size: 16px;">@lang('home.Loading')  ...</div>
                            ...
                            {{--<li>
                                <strong>@lang('home.Refundable Amount For Selling') (-1%)</strong>
                                <p class="commissionFee">--</p>
                            </li>--}}
                            <li>
                                <strong>@lang('home.Refundable Deposit') [<a href="#" data-toggle="modal" data-target="#refundablePopup">@lang('home.Learn More')</a>] (-1%)</strong>
                                <div class="donation" style="font-size: 10px;">
                                    <span>@lang('home.Do you want to donate the deposit')</span>
                                    <input type="checkbox" name="donate">
                                </div>
                                <p class="commissionFee">--</p>
                            </li>
                            {{--<li>
                                <strong>@lang('home.Do you want to donate the deposit')</strong>
                                <input type="checkbox" name="donate">
                            </li>--}}
                        </ul>
                    ...
                    <div class="col-lg-4 col-md-4 col-xs-12">
                        <ul class="borderLeft">
                            ...
                            <li><div class="payment_message" style="color: red; display: none;">@lang("home.Price is not appropriate for making an offer.")</div></li>
                            <li>
                                <button type="submit" id="bidNowButton">@lang('home.Submit')</button>
                            </li>
                        </ul>
...
//return false;
        ...
        $('#enterBidPrice').on('change', function (e) {
            ...
            if (countryCode == 'CN') {
                ...
                if (toPostalCode == '') {
                    ...
                    /*$('html, body').animate({
                     scrollTop: $("#shipping_zip").offset().top
                     }, 2000);*/
                } else {
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    if (this.status == 200) {
                        ...
                        console.log('final price--->' + finalCalPrice + '++++++after cal commissionPrice --->' + comPrice + 'processing fees--->'+processingFee);
                        ...
                        if(finalCalPrice < 1){
                            ...
                            $('.totalPrice').html(finalCalPrice.replace(/[$-]/g, function($1) { return $1 === '-' ? '$' : ' ' })); //removed the negative symbol
