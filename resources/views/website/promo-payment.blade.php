...
@section('content')
<div class="container fullHeight-container">
		<div class='row hypeCardPage'>
                ...
                <div class="hypeCard cardPadding">
                        ...
                        <div class="cardInner">
                            ...
                            <div class="cardrow">
                                ...
                                <div class="cardExpiryDate">
                                    <label>Valid<br />Through</label>
                                    <div class="ExpDate">
                                        <label>Month/Year</label>
                                        <div class="monthYear1"><span class="month">MM</span> <small>/</small> <span class="year">YYYY</span> </div>
                                    </div>
                                </div>
                            </div><!-- row ends -->
                    ...
                    <!-- ============================================= card face 2 start ===================== -->
                     ...
                     <div class="hypeCardFace hypeCardFace-back">
                        ...
                        <div class="cardCvv"><div class="cvvStripe"></div><span class="backsideCVV">CVV</span></div>
			...
			<div class='hype-card-block cardDetailForm'>
				<script src='https://js.stripe.com/v2/' type='text/javascript'></script>
                  ...
                  <form accept-charset="UTF-8" action="{{ route('promo-payment') }}" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="pk_test_4IM4LmSwVO580Z1zC3BsShzx" id="payment-form" method="POST">

				 <!--form accept-charset="UTF-8" action="{{ route('promo-payment') }}" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="pk_live_VCgTWfZJ6eQGGJPba9ddqug3" id="payment-form" method="POST"-->
					...
					{{ csrf_field() }}
                     ...
                     <div class='form-row'>
						<div class='col-xs-12 form-group required'>
							<label class='control-label'>Payout PayPal Email</label> <input
								class='form-control paypal_id' size='4' type='email' pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" size="30" required>
						</div>
					</div>
					<!-- account details -->
					<div class='form-row'>
					...
					<div class='form-row'>
						<div class='col-md-12 form-group'>
							<button class='form-control btn btn-primary submit-button'
								type='submit' style="margin-top: 10px;">Pay CAD ${{ Session::get('totalPrice') }}</button>
						</div>
					</div>
					<div class='form-row'>
			...
			$(function() {
			  ...
			  function stripeResponseHandler(status, response) {
			    if (response.error) {
			      ...
			      $form.append("<input type='hidden' name='paypal_id' value='" + paypal_id + "'/>");
                  $form.get(0).submit();
			    }
			  }
			})
