                ...
                <div class="row">
                    ...
                    <div class="text-center vip-title">
                        <div class="vip-section-title">
                            ...
                            <p>
                                <a class="active vip-btn" id="storebtn"
                                   href="javascript:void('0')">@lang("home.VIP Store")</a>
                                <a class="vip-btn" id="salebtn" href="javascript:void('0')">@lang("home.VIP Sale")</a>
                            </p>
                        </div>
                    </div>


                    <div class="col-md-12 " id="vip-store-button" style="display:block;">

                        <!-- timer starts here rv-->
                        <!--div class="text-center">
                            ...
                            <div class="vip-timer-inner">
                                ...
                                <div class="countdownn countdown-container container"><div class="clock-item clock-days countdown-time-value col-xs-3 col-sm-3 col-md-3"><div class="wrap"><div class="inner"><div id="canvas-days" class="clock-canvas"></div><div class="text"><p class="val">03</p><p class="type-days type-time">DAYS</p></div></div></div></div><div class="clock-item clock-hours countdown-time-value col-xs-3 col-sm-3 col-md-3"><div class="wrap"><div class="inner"><div id="canvas-hours" class="clock-canvas"></div><div class="text"><p class="val">21</p><p class="type-hours type-time">HOURS</p></div></div></div></div><div class="clock-item clock-hours countdown-time-value col-xs-3 col-sm-3 col-md-3"><div class="wrap"><div class="inner"><div id="canvas-hours" class="clock-canvas"></div><div class="text"><p class="val">36</p><p class="type-hours type-time">MINUTES</p></div></div></div></div><div class="clock-item clock-hours countdown-time-value col-xs-3 col-sm-3 col-md-3"><div class="wrap"><div class="inner"><div id="canvas-hours" class="clock-canvas"></div><div class="text"><p class="val">46</p><p class="type-hours type-time">SECONDS</p></div></div></div></div></div>
                                            ...
                                            <div class="product-grid">
                                                ...
                                                <div class="product-thumb-info">
                                                    ...
                                                    <div class="product-price">
                                                        ...
                                                        </span><span>{{$singleProduct['start_counter']}} @lang('home.Sold')</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </a>
                    ...
                    <div class="col-md-12 " id="vip-sale-button" style="display:none;">
                    ...
                    {{--@if(count($vipData) >= 10)--}}
                    @if(count($vipData) >= 10)
                        <div class="load-more text-center"><a class="custom_outlinebtn"
                                    href="{{url('/vip/vip-sale')}}">@lang("home.More Products")</a></div>
                    @endif
                </div>
            </div>
        </div>
        ...
        <div class="index-block vip-plans" id="vipplans">
            ...
            <script type="text/javascript">
                ...
                $('#buynow').on('click', function (e) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response == 0) {
                                window.location.href = '<?php echo route('buy_plan',
									['id' => base64_encode($plans[0]['id'])]) ?>';
                            } else {
                                $('#successmessage').show();
                                setTimeout(function () {
                ...
                $("#storebtn").click(function () {
                    ...
                    $("#vip-sale-button").hide();
                    $("#vip-store-button").show();
                ...
                $("#salebtn").click(function () {
                    ...
                    $("#vip-store-button").hide();
                    $("#vip-sale-button").show();
