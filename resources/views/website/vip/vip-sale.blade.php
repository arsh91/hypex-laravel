                ...
                <div class="row">
                    ...
                    <div class="col-md-8 text-left">
                        ...
                        <div class="vip-timer-inner">
                            ...
                            <div class="countdownn countdown-container container">
                                <div class="clock row">
...
<!-- 
                    ...
                    <div class="col-md-4 vip-banner-girl"><img src="{{ url('public/v1/website/img/girl-sitting.png') }}"
                                                               alt=""/></div>
        ...
        <div class="index-block vip-product-listing">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 " id="moreproduct">
                        <ul class="vip-tab1 vip-product-list">

                        <div class="col-md-12 ">
                        <ul class="vip-tab1 vip-product-list morepro">
                            @if(count($vipSale) > 0)
                                            ...
                                            <div class="product-grid">
                                                ...
                                                <div class="product-thumb-info">
                                                    ...
                                                    <div class="product-price"><span>
                                                        <strong>
                                                            {{App\Helpers\WebHelper::currencyConversion(Session::get('currencyCode'), $singleProduct['currency_code'], $singleProduct['retail_price'])}}</strong>
                                                    </span><span>{{$singleProduct['start_counter']}} @lang('home.Sold')</span></div>
                                                </div>
                                            </div>
                                        </a>
                    ...
                    <!-- @if(count($vipSale) >= 10)
                        <div class="load-more text-center"><a href="#" id="loadmorevip">Load More</a></div>
                    @endif -->
                    <div class="clearfix"></div>
                    @if($vipSale->hasMorePages() == 1)
                        <div class="custom_gap text-center"><button id="load-more" type="button" class="btn w-100 custom_outlinebtn" data-page="{{ $vipSale->currentPage() }}">Load More</button></div>
                    @endif
        ...
        <script type="text/javascript" src="HYPEX_files/kinetic.js"></script>
        <script type="text/javascript" src="HYPEX_files/jquery.final-countdown.js"></script>
        ...
        <script type="text/javascript">
            ...
            //     + '<span>%S</span> sec'));
            // });
            $('.countdownn').countdown('<?php echo $vipCountertime['start_date']; ?>')
            ...
            $('#load-more').click(function () {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#moreproduct .morepro').append(data.html);
                        $("#scrapLoading").hide();
