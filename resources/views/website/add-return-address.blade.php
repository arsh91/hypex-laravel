                ...
                <div id="exTab1" class="container-fluid"> 
                    ...
                    <div class="col-md-12">
                        <ul  class="navtabsAccount">
                            <li class="active"><a  href="#1a" data-toggle="tab">Add Return Address</a></li>
                        </ul>
                    </div><!-- col ends -->
                        ...
                        <form method="POST" action="{{ route('save-return-address')}}">
                        @csrf
                                ...
                                <div class="tab-pane-inner">
                                    ...
                                    <div class="row-fluid">
                                        <div class="col-md-6 colinput btnFormSubmit">
                                            <input type="submit" name="add_billing_address" value="Add" />
                                        </div> <!-- col ends -->
                                        <div class="col-md-6 colinput linkCancel">
                                            @if($userReturnAddr >1 )
                                                <a href="{{url('view-return-address')}}">Cancel</a>
                                                @else
                                                <a href="{{url('user-account')}}">Cancel</a>
                                            @endif
                                        </div> <!-- col ends -->
