                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                  ...
                                  @if($order['status'] == 1)
                                  <a href="{{url('admin/order/reject-order/'.$order['id'].'/0')}}" class="btn btn-gradient-danger btn-sm" onclick = "if (! confirm('Do you want to reject this order number {{$order['id']}}?')) { return false; }">Reject</a>
                                  @endif
