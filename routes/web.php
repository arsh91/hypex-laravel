...
Route::namespace('v1\admin')->middleware(['auth:web','checkIsAdminLogin'])->group(function () {
	...
	Route::match(['get'],'admin/deactivated-product-list','ProductManagementController@deactivatedProducts');
	...
	Route::match(['get'],'admin/remove-product/{id}','ProductManagementController@removeProduct');
